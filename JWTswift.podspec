#
#  Be sure to run `pod spec lint JWTswift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Julius Saputra"
  # s.authors            = { "Julius Saputra" => "julius_saputra@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/Julius Saputra"
